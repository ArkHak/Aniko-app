package com.anixkmp.buildlogic
 ...
 *
 * Держится здесь, а не копипастой в `anix.kmp.library` / `anix.kmp.application`:
 ...
 */
internal fun KotlinMultiplatformExtension.configureAnixTargets(jvmTargetVersion: String) {
 ...
 */
internal fun CommonExtension<*, *, *, *, *, *>.configureAnixAndroid(
