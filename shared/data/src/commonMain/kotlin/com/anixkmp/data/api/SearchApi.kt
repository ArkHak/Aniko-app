...
import com.anixkmp.data.dto.SearchRequestDto
 ...
 *
 * `token` в тело/query добавлять не нужно — [com.anixkmp.network.AnixTokenPlugin] дописывает
 ...
 * [com.anixkmp.network.ApiConfig.apiVersionHeader] когда-нибудь станет не-`null`, он всё равно
