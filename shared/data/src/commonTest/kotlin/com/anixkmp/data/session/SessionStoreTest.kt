...
class SessionStoreTest {
    ...
    @Test
    fun onUnauthorized_clearsSecureStorage_and_emitsSessionExpired() = runTest {
    ...
    @Test
    fun clear_clearsSession_but_doesNotEmitSessionExpired() = runTest {
    ...
    @Test
    fun bootstrap_loadsToken_and_setsAuthorizedState() = runTest {
    ...
    @Test
    fun bootstrap_setsUnauthorizedState_when_noTokenSaved() = runTest {
    ...
    @Test
    fun save_persists_token_and_profileId() = runTest {
        // Arrange
        val secureStorage = FakeSecureTokenStorage()
        val settings = MapSettings()
        val sessionStore = SessionStore(settings, secureStorage)
